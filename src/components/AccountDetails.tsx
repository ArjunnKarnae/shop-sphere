  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
        ...
        <div>
          ...
          <p className="mt-1 text-md text-gray-900">{data?.firstName} {data?.lastName}</p>
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700">Email Address</label>
          <p className="mt-1 text-md text-gray-900">{data?.email}</p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-md text-gray-900">{data?.phone}</p>
        </div>
      </div>
    </div>
    );
